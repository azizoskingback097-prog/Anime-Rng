-- ═══════════════════════════════════════════════════════════
-- 🔧 VFX CLEAN FIX — includes your "White" VFX + "Akaza" mapping
-- ═══════════════════════════════════════════════════════════
-- HOW TO USE: View > Command Bar → paste ALL of this → Enter
--
-- This REPLACES VFXData with a CLEAN version that includes:
--   • All 7 original VFX (Smoke Mist, Stardust, Fire Burst, etc.)
--   • Your custom "White" Template VFX (uses CustomVFX/White)
--   • "Akaza" mapped to "White"
--
-- ⚠️ STOP editing VFXData manually by copy-pasting from chat!
--    Your chat turns function names into broken links.
--    ALWAYS use this command bar instead!
-- ═══════════════════════════════════════════════════════════
...
VFXData.VFX["White"] = { Name = "White", Effects = {
	{ Type = "Template", TemplateName = "White", Part = "HumanoidRootPart" },
}}
...
print("══════════════════════════════════════")
print("✅ VFX CLEAN FIX APPLIED!")
print("══════════════════════════════════════")
print("🔧 Fixed: removed markdown corruption + double brace")
print("✨ Your 'White' VFX is connected to 'Akaza' aura")
print("📁 Make sure your VFX is in ReplicatedStorage/CustomVFX/White")
print("══════════════════════════════════════")
print("🎮 TEST:")
print("   1. Press Play")
print("   2. Admin → give yourself Akaza")
print("   3. Inventory → equip Akaza")
print("   4. Check Output for debug messages!")
print("══════════════════════════════════════")
print("⚠️ REMEMBER: Never edit VFXData by copy-pasting from chat!")
print("   Chat breaks the code. Always use the command bar.")
print("══════════════════════════════════════")
