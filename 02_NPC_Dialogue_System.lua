-- ═══════════════════════════════════════════════════════════
-- 🗣️ NPC DIALOGUE SYSTEM (Grow a Garden Style!)
-- ═══════════════════════════════════════════════════════════
-- Paste in Command Bar → Enter
--
-- Features:
--   • Press E to talk to NPC
--   • Random greeting appears
--   • 3 Options: Open Shop, Ask Story, Nevermind
...
-- ⚙️ DIALOGUE CONFIGURATION (Super Customizable!)
local GREETINGS = {
...
local DialogueEvent = ReplicatedStorage.Remotes:FindFirstChild("DialogueEvent")
if not DialogueEvent then
	DialogueEvent = Instance.new("RemoteEvent")
	DialogueEvent.Name = "DialogueEvent"
	DialogueEvent.Parent = ReplicatedStorage.Remotes
end
...
print("✅ NPC Dialogue System ready! (Grow a Garden Style)")
]==]

print("✅ NPC DIALOGUE SYSTEM INSTALLED!")
print("🗣️ Press E near ShopDealler for 3 options!")
